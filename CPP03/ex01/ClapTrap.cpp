...
/*   Updated: 2022/07/23 16:54:19 by hmoubal          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(int HP, int EN, int AD) : HP(HP), EN(EN), AD(AD)
{
	std::cout << "ClapTrap Default Constructor called" << std::endl;
}

ClapTrap::ClapTrap(std::string str, int HP, int EN, int AD) : name(str), HP(HP), EN(EN), AD(AD)
{
	std::cout << "ClapTrap Name Constructor called" << std::endl;
}
